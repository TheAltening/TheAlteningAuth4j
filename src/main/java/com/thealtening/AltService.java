...
public class AltService {
    ...
    private void reflectionFields(String authServer) throws NoSuchFieldException, IllegalAccessException {
        ...
        userAuthenticationModifies.put("ROUTE_INVALIDATE", constantURL("https://authserver" + authServer + "thealtening.com/invalidate"));
        ...
        minecraftSession.setStaticField("BASE_URL", "https://sessionserver." + authServer + ".com");
